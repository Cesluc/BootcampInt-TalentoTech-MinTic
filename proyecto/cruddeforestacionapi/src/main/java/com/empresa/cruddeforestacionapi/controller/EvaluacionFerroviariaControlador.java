...
public class EvaluacionFerroviariaControlador {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<EvaluacionFerroviariaDTO> obtenerEvaluacionFerroviaraPorId(@PathVariable Long id) {
        EvaluacionFerroviariaDTO evaluacionFerroviariaDTO = evaluacionFerroviariaServicio.obtenerEvaluacionFerroviaraPorId(id);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<EvaluacionFerroviariaDTO> actualizarEvaluacionFerroviariaPorIdString(@PathVariable Long id, @RequestBody EvaluacionFerroviariaDTO evaluacionFerroviariaDTO) {
        EvaluacionFerroviariaDTO evaluacionFerroviariaDTOActualizada = evaluacionFerroviariaServicio.actualizarEvaluacionFerroviariaPorIdString(id, evaluacionFerroviariaDTO);

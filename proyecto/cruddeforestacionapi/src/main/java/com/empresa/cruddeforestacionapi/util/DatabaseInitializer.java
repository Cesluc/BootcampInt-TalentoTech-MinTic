...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        entityManager.createNativeQuery(
                "DROP FUNCTION IF EXISTS calcular_indice_deforestacion").executeUpdate();
        ...
        entityManager.createNativeQuery(
                "DROP TRIGGER IF EXISTS actualizar_indice_deforestacion").executeUpdate();
        ...
        entityManager.createNativeQuery(
                "DROP PROCEDURE IF EXISTS insertar_evaluacion").executeUpdate();
